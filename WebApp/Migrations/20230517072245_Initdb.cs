        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompapanyName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserAddressEntityAddressId = table.Column<int>(type: "int", nullable: true),
                    UserAddressEntityUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUserAddresses_AspNetUserAddresses_UserAddressEntityUserId_UserAddressEntityAddressId",
                        columns: x => new { x.UserAddressEntityUserId, x.UserAddressEntityAddressId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserAddresses_UserAddressEntityUserId_UserAddressEntityAddressId",
                table: "AspNetUserAddresses",
                columns: new[] { "UserAddressEntityUserId", "UserAddressEntityAddressId" });
