...
namespace WebApp.Migrations
{
    ...
    [Migration("20230522152106_Product-update")]
            ...
            modelBuilder.Entity("WebApp.Models.Entities.UserAddressEntity", b =>
                {
                    ...
                    b.Property<int?>("UserAddressEntityAddressId")
                        .HasColumnType("int");

                    b.Property<string>("UserAddressEntityUserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("UserAddressEntityUserId", "UserAddressEntityAddressId");
            ...
            modelBuilder.Entity("WebApp.Models.Identity.AppUser", b =>
                {
                    ...
                    b.Property<string>("CompapanyName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("WebApp.Models.Entities.UserAddressEntity", b =>
                {
                    ...
                    b.HasOne("WebApp.Models.Entities.UserAddressEntity", null)
                        .WithMany("Addresses")
                        .HasForeignKey("UserAddressEntityUserId", "UserAddressEntityAddressId");
